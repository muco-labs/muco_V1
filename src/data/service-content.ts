...
export const serviceContent: ServiceContent[] = [
  {
    ...
    builds: [
      ...
      'Technical SEO, SSL and Core Web Vitals focus',
  ...
  },
  {
    ...
    category: 'Build',
    summary: 'Custom applications, CRM/ERP and multi-tenant SaaS platforms built for real operations.',
    ...
    builds: [
      'Enterprise backends and microservices',
      'Super-admin and user portals',
      'Stripe / Razorpay billing engines',
  ...
  },
  {
    ...
    category: 'Build',
    summary: 'Native-quality iOS & Android experiences with React Native or Flutter.',
    forWho: 'Businesses needing mobile apps tied to real backend workflows and store publishing.',
    problem: 'Mobile ideas stuck in prototypes without reliable release and update paths.',
    builds: [
      'Cross-platform or native strategy',
      'Backend API architecture',
      'Push notification servers',
      'Offline-aware UX and secure auth',
  ...
  },
  {
    ...
    summary: 'Custom LLM agents, RAG chatbots and OCR automation—with human oversight.',
    ...
    builds: [
      'Custom RAG trained on your documents',
      'Website, WhatsApp and Telegram deployment',
      'OCR / invoice extraction pipelines',
      'Human agent fallback and analytics',
    ],
  ...
  },
  {
    ...
    forWho: 'Founders and product teams shaping what to build—or refining what already exists.',
    ...
    process: ['Discover', 'Structure', 'Design', 'Prototype', 'Validate', 'Handoff'],
  },
  {
    slug: 'seo',
    title: 'SEO',
